...
abstract class Process extends Initialize
{
	...
	public function transmitMessage($msgObj)
	{
		if ($this->isInit() === false) {
			...
			$rawMsg		= base64_encode(json_encode($msgObj->getResponseMsg(), JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES));
			...
			throw new \Exception("Cannot transmit message, this connection is not rx or tx for the message", 1111);
		}
		return $this;
	}
}